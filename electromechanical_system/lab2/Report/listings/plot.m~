...
%open('SineWaveZeroCondition');
%sim('SineWaveZeroCondition');
open('ConstantZeroCondition');
sim('ConstantZeroCondition');
%open('ZeroImpactNoZeroCondition');
%sim('ZeroImpactNoZeroCondition');
Time = result.time;
